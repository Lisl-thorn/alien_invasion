...
def create_fleet(ai_settings, screen, ship, aliens):
	...
	for number_row in xrange(number_rows):
...
def save_history_high_score(stats):
	history_high_score = 0
	try:
		with open("high_score.txt") as history_high_score_file:
			history_high_score = json.load(history_high_score_file)
	except IOError:
		with open("high_score.txt","w") as history_high_score_file:
			json.dump(history_high_score, history_high_score_file)
	if stats.high_score > history_high_score:
